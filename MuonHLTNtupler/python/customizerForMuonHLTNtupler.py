...
def customizerFuncForMuonHLTNtupler(process, newProcessName = "MYHLT", doDYSkim = False):
    ...
    process.AhltPhase2L3MuonMerged                                = hltMuonAssociatorByHits.clone( tracksTag = 'hltPhase2L3MuonMerged' )
    ...
    process.trackAssoSeq = cms.Sequence(
        ...
        process.AhltPhase2L3MuonMerged + 
    ...
    process.ntupler.iterL3MuonMerged              = cms.untracked.InputTag("hltPhase2L3MuonMerged",              "", newProcessName)
