...
# with command line options: step2 -s L1P2GT,HLT:75e33,VALIDATION:@hltValidation --conditions auto:phase2_realistic_T33 --datatier GEN-SIM-DIGI-RAW,DQMIO -n 10 --eventcontent FEVTDEBUGHLT,DQMIO --geometry ExtendedRun4D110 --era Phase2C17I13M9 --filein file:/eos/cms/store/relval/CMSSW_15_1_0_pre4/RelValZMM_14/GEN-SIM-DIGI-RAW/PU_150X_mcRun4_realistic_v1_STD_Run4D110_PU-v1/2580000/0408f86f-89ef-49c9-8a90-7143d2afe66f.root --fileout file:step2_alpaka.root --process MYHLT --inputCommands=keep *, drop *_hlt*_*_HLT, drop triggerTriggerFilterObjectWithRefs_l1t*_*_HLT --procModifiers alpaka,phase2CAExtension --python_filename hlt_luca_alpaka.py --nThreads 1 --no_exec
...
process = cms.Process('MYHLT',Phase2C17I13M9,alpaka,phase2CAExtension)
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/eos/cms/store/relval/CMSSW_15_1_0_pre4/RelValTTbar_14TeV/GEN-SIM-DIGI-RAW/PU_150X_mcRun4_realistic_v1_STD_Run4D110_PU-v1/2580000/878511a1-1702-461a-8b93-0e38190f6d96.root'),
    ...
    #skipEvents = cms.untracked.uint32(61)
)
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step2_alpaka.root'),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('file:step2_alpaka_inDQM.root'),
...
process.hltvalidation.visit(ConfigBuilder.MassSearchReplaceProcessNameVisitor("HLT", "MYHLT", whitelist = ("subSystemFolder",), verbose = False))
process.prevalidation.visit(ConfigBuilder.MassSearchReplaceProcessNameVisitor("HLT", "MYHLT", whitelist = ("subSystemFolder",), verbose = False))
