...
void drawBDTEffFull_binary_origin(
  ...
  vector<TString> types_file = {
				"Phase2_Muon_hist-Phase2_Spring24_1600pre3_default-Phase2_Spring24_1600pre3_default.root",
				"Phase2_Muon_hist-Phase2_Spring24_1600pre3_seedless-Phase2_Spring24_1600pre3_seedless.root",
				"Phase2_Muon_hist-Phase2_Spring24_1600pre3_generalTracks-Phase2_Spring24_1600pre3_generalTracks.root",
				"Phase2_Muon_hist-Phase2_Spring24_1600pre3_offline-Phase2_Spring24_1600pre3_offline.root",
				"Phase2_Muon_hist-Phase2_Spring24_1600pre3_singleIterTracking-Phase2_Spring24_1600pre3_singleIterTracking.root",
				"Phase2_Muon_hist-Phase2_Spring24_1600pre3_singleIterTracking_generalTracks-Phase2_Spring24_1600pre3_singleIterTracking_generalTracks.root",
				"Phase2_Muon_hist-Phase2_Spring24_1600pre3_singleIterTracking_offline-Phase2_Spring24_1600pre3_singleIterTracking_offline.root",
  };

  vector<TString> types_str = {
    "L2Muon from L1TkMu",
    "Seedless OI",
    "Filtered general tracks as IO",
    "Offline strategy",
    "Single-iteration",
    "Single-iteration - filtered general tracks",
    "Single-iteration - offline strategy"
  };
