...
# with command line options: Phase2 -s L1,L1TrackTrigger,L1P2GT,HLT:75e33,VALIDATION:@hltValidation --processName=MYHLT --conditions auto:phase2_realistic_T35 --geometry ExtendedRun4D121 --era Phase2C17I13M9 --eventcontent FEVTDEBUGHLT,DQMIO --datatier GEN-SIM-DIGI-RAW-MINIAOD,DQMIO --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000,Configuration/DataProcessing/Utils.addMonitoring,L1Trigger/Configuration/customisePhase2FEVTDEBUGHLT.customisePhase2FEVTDEBUGHLT,L1Trigger/Configuration/customisePhase2TTOn110.customisePhase2TTOn110 --filein /store/mc/Phase2Spring24DIGIRECOMiniAOD/DYToLL_M-50_TuneCP5_14TeV-pythia8/GEN-SIM-DIGI-RAW-MINIAOD/PU200_Trk1GeV_140X_mcRun4_realistic_v4-v1/2810000/67e21bae-f9cd-43f1-8974-e163400220f7.root --fileout file:output_Phase2_L1T.root --python_filename hlt_muon_mc_default.py '--inputCommands=keep *, drop l1tPFJets_*_*_*, drop l1tTrackerMuons_l1tTkMuonsGmt*_*_HLT, drop *_hlt*_*_HLT, drop triggerTriggerFilterObjectWithRefs_l1t*_*_HLT' --mc -n 100 --nThreads 1 --no_exec
...
process = cms.Process('MYHLT',Phase2C17I13M9,singleIterPatatrack,phase2CAExtension,trackingLST,seedingLST,trackingMkFitCommon,hltTrackingMkFitInitialStep)
...
process.source = cms.Source("PoolSource",
    ...
    #fileNames = cms.untracked.vstring('/store/relval/CMSSW_16_1_0_pre2/RelValZMM_14/GEN-SIM-DIGI-RAW/PU_150X_mcRun4_realistic_v1_STD_D121_RegeneratedGS_PU-v1/2590000/08547e89-a959-4bbd-84d0-af3e85ce5e9c.root'),
    fileNames = cms.untracked.vstring('/store/mc/Phase2Spring24DIGIRECOMiniAOD/DYTo2L_Bin-M-50_TuneCP5_14TeV_pythia8/GEN-SIM-DIGI-RAW-MINIAOD/PU140_Trk1GeV_140X_mcRun4_realistic_v5-v1/2810000/00021d9f-9ae0-4cf9-96b9-574212bb82dc.root'),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('file:output_Phase2_L1T_inDQM.root'),
...
process.schedule.extend([process.FEVTDEBUGHLToutput_step,process.DQMoutput_step])
...
from customizeMuonL3FromSAGE import customizeMuonL3FromSAGE
process = customizeMuonL3FromSAGE(process)
